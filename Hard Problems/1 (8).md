...
هذا الكود يحسب عمرك بالأيام بناءً على تاريخ ميلادك مقارنة بالتاريخ الحالي!

يطلب منك إدخال تاريخ ميلادك (يوم، شهر، سنة) ثم يحسب الفرق بالأيام بينه وبين تاريخ اليوم، مع مراعاة السنوات الكبيسة وعدد أيام كل شهر. النتيجة تعرض عدد الأيام التي عشتها منذ ولادتك حتى اليوم.
...
int main()
{
	...
	Data3.day = now->tm_mday;
	Data3.month = now->tm_mon + 1;
	Data3.year = now->tm_year + 1900;

	Data = Data1();
	
	cout << "\nyour age by days is : " << DefrintDays(Data, Data3) << "(s)" << endl;
